...
error_reporting(0);
        session_start();
if($_SESSION['servicetype']=='Periodic Servicing'){

}
elseif($_SESSION['servicetype']=='Repair'){
...
function fillgrid(){
    ...
    var xmlhttp;
    var pre='<table id="example1" class="table table-bordered table-striped"><thead><tr><th>Service Provider</th><th style="width:12%">Rating</th><th>Address</th><th>Amenities</th><th>Price(INR)</th><th>Select</th></tr></thead><tbody>';    
    var post='</tbody><tfoot><tr><th>Service Provider</th><th>Rating</th><th>Address</th><th>Amenities</th><th>Price(INR)</th><th>Select</th></tr></tfoot></table>';
    if (window.XMLHttpRequest)
    { /*code for IE7+, Firefox, Chrome, Opera, Safari*/
    xmlhttp=new XMLHttpRequest();
    }
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <section class="sidebar"></br></br></br>
                ...
                <ul class="sidebar-menu">
                    ...
                    <!-- <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                        <li><div class="checkbox" ><label ><input id="check" type="checkbox" name="pickup" ><span style="margin-left:5px"><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i></span></label></div></li>
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" style="margin-right:5px"><span style="margin-left:5px"><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i></span></label></div></li>
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" style="margin-right:5px"><span style="margin-left:5px"><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star-half-empty"style="margin-left:5px;color:orange"></i></span></label></div></li>
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" style="margin-right:5px"><span style="margin-left:5px"><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i></span></label></div></li>
                        </ul>
                    </li> -->
                    <li class="treeview active">
        ...
        <aside class="right-side">                
            ...
            <section class="content">
              ...
              <form action="cat1Buk.php" method="POST">
...
$place=$_SESSION['area'];
    ...
    or die("Invalid query: " . mysql_error());
    $O_row='  <table id="example1" class="table table-bordered table-striped"><thead>                                    <tr>                                                                    <th>Service Provider</th>                                     <th style="width:12%">Rating</th>                                     <th>Address</th>                                     <th>Amenities</th>                                    <th>Price(INR)</th>                                     <th>Select</th>                                 </tr>                             </thead><tbody>';
...
$O_row.='</tbody><tfoot>                            <tr>                              <th>Service Provider</th>                              <th>Rating</th>                              <th>Address</th>                              <th>Amenities</th>                              <th>Price(INR)</th>                              <th>Select</th>                          </tr>                      </tfoot>                  </table>';

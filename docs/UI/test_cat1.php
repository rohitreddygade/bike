                ...
                <ul class="sidebar-menu">
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li>
                                 <div class="nstSlider" data-range_min="300" data-range_max="2000" 
                    ...
                    <li class="treeview active">
                        ...
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" ><span style="margin-left:5px">Home Pick-Up</span></label></div></li><!-- Changed -->
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" style="margin-right:5px"><span style="margin-left:5px">Home Drop-off</span></label></div></li><!-- Changed -->
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" style="margin-right:5px"><span style="margin-left:5px">Insurance</span></label></div></li><!-- Changed -->
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" style="margin-right:5px"><span style="margin-left:5px">Pay Online</span></label></div></li><!-- Changed -->
                        </ul>
                    </li>
                    <li class="treeview active">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><div class="checkbox" ><label><input type="checkbox" name="pickup" ><span style="margin-left:5px"><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i></span></label></div></li><!-- Changed -->
                        ...
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" style="margin-right:5px"><span style="margin-left:5px"><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star-half-empty"style="margin-left:5px;color:orange"></i></span></label></div></li><!-- Changed -->
                        <li><div class="checkbox" style=""><label><input type="checkbox" name="pickup" style="margin-right:5px"><span style="margin-left:5px"><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i><i class="fa fa-star" style="margin-left:5px;color: orange;;color: orange;"></i></span></label></div></li><!-- Changed -->
                        </ul>
                    </li>
                </ul>

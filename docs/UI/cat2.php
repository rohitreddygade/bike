...
error_reporting(0);
        session_start();
if($_SESSION['servicetype']=='Query'){
}elseif($_SESSION['servicetype']=='Insurance' or $_SESSION['servicetype']=='Periodic Servicing'){
...
header('location: cat3.php',true,303);
}else{
...
xmlhttp.open("POST","../Service/fetch_shwrum_q.php",true);
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">                
            ...
            <section class="content">
              ...
              <form action="cat2Buk.php" method="POST">
              <div id="shwRum_buk_slots"  style="padding:10px;"  class="box">
                 <div class="box-body" >
...
$place=$_SESSION['area'];
    ...
    or die("Invalid query: " . mysql_error());
    $O_row='  <table id="example1" class="table table-bordered table-striped"><thead><tr>                                                                    <th>Service Provider</th>                                     <th style="width:12%">Rating</th>                                     <th>Address</th>                                     <th>Amenities</th>                                             <th>Select</th>                                 </tr>                             </thead><tbody>';
    ...
    while ($rw1 = mysql_fetch_array($queryx_result)) {
        ...
        $O_row.="<td>".$amnty."</td>";
        $O_row.='<td><label class="select"><input type="checkbox" id="'.$rw1['S_id'].'_'.$rw1['lati'].'_'.$rw1['longi'].'_'.$rw1['S_name'].'" class="btn btn-success btn-flat select" style="margin-left:35px" /></label></td>';
        $O_row.="</tr>";
         }
     }

...
header('location: voview.php',true,303);
}
?>
<!DOCTYPE html>
<html class="bg-black">
    ...
    <body class="bg-black">
        ...
        <div class="form-box" id="login-box">
            <div class="header">Vendor Sign In</div>
...
if(isset($_POST['signIN'])){
    $query = "SELECT * FROM serv_center where S_name='".$_POST['userid']."'";
    $query_result = mysql_query($query,$con)
    or die("Invalid query: " . mysql_error());
   $rw1 = mysql_fetch_array($query_result);
   if($rw1['pwd']==$_POST['pwd']){

    $_SESSION['sname']=$rw1['S_name'];
    $_SESSION['sid']=$_POST['userid'];
    echo '<script type="text/javascript"> window.location.href = "http://localhost/boss/docs/UI/voview.php";</script>';

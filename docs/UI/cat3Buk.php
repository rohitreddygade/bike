                        ...
                        <div id="accordion1">
                            ...
                            <div  class="mxHelpFiltersExpandedView"
                                style="min-height: 0px !important">
                                        ...
                                        <div class="form-group col-xs-4" style="">
                                            <label for="exampleInputPassword1">Repair Description in Brief<!--Added--><span class="error" >*</span></label>
                                            <input type="text" class="form-control" onchange="checkfield();" name="repairB" id="repairB" placeholder="eg. Chain Repair">
                                        </div>
                                        <div class="form-group col-xs-4" style="">
                                            <label for="exampleInputPassword1">Repair Description in Detail<!--Added--></label>
                                            <textarea type="text" class="form-control"  name="area" id="area" placeholder="Explain more about the repair..."></textarea>
                                        </div>
                                        
                                        
                                        <div class="form-group col-xs-4" style="margin-top:4%">
                                            <label><input id="facet12" type="checkbox"
                                            value="help_use" onclick="handleClick('SCENARIOS','facet12');"><span style="margin-lefT:10px;margin-bottom:1px;">Need Home PickUp</span></label>
                                        </div>
...
function checkfield(){
    ...
    var e5 = document.getElementById("repairB").value;
    var x=0;
    var e4 = 0;

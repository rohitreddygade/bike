...
header('location: ucat1.php',true,303);
}else{
                    ...
                    <div class="row">
                        <div class="col-xs-12">                            
                            <div class="box">
                                   ...
                                   <?php echo $_SESSION['company']." ".$_SESSION['model']." , ".$_SESSION['servicetype']." on ".$_SESSION['date']." near ".$_SESSION['area'];?></h4>
                                <div class="">
  ...
  -webkit-font-smoothing: antialiased;" id="submit" class="btn btn-primary">ModifySearch</button>                                    
                       ...
                       <div class="form-group" style="margin-left:15px"> 
                                ...
                                <div class="checkbox" style="margin-left:0px">
                                        ...
                                        <form action="ucat2.php" method="POST">

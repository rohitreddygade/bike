                        ...
                        <div id="accordion1">
                            ...
                            <div  class="mxHelpFiltersExpandedView"
                                style="min-height: 0px !important">
                                        ...
                                        <div class="form-group col-xs-4" style="">
                                            <label for="exampleInputPassword1">Query Description in Brief<!--Added--><span class="error" >*</span></label>
                                            <input type="text" class="form-control" onchange="checkfield();" name="queryB" id="queryB" placeholder="eg. Chain Repair">
                                        </div>
                                        <div class="form-group col-xs-4" style="">
                                            <label for="exampleInputPassword1">Query Description in Detail<!--Added--></label>
                                            <textarea type="text" class="form-control"  name="area" id="area" placeholder="Enter your full Address here..."></textarea>
                                        </div>
                            ...
                            <div  class="mxHelpFiltersExpandedView"
                                ...
                                <?php echo "<span style='font-size:16px;line-height:1'>You have opted for <i style='color:rgb(77, 121, 199)'>".$_SESSION['servicetype']."</i> on <i style='color:rgb(77, 121, 199)'>".$_SESSION['date']."</i> for your <i style='color:rgb(77, 121, 199)'>".$_SESSION['bike']."</i> in <i style='color:rgb(77, 121, 199)'>Rakesh Motors </i>near <i style='color:rgb(77, 121, 199)'>".$_SESSION['area']."</i></span>";                     
                              ?>
...
function checkfield(){
    ...
    var e5 = document.getElementById("queryB").value;
    var x=0;
    var e4 = 0;

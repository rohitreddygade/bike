...
$query = "SELECT * FROM slots where (sid=$sid and day='2014-08-14')";
    $query_result = mysql_query($query,$con)
    or die("Invalid query: " . mysql_error());
   $O_row="";
   $rack=array();
   while ($rw1=mysql_fetch_array($query_result)) {
        array_push($rack,$rw1['slots']);
    }
    for($i=0;$i<10;$i++){
            $O_row.="<tr><td> Rack ".chr($i+65)."</td>";
            foreach ($rack as $key => $value) {
                    if($value<10 && $value!='-'){
                        ...
                        $rack[$key]['value']=$value+1;
                        if($i==0){
                            $rack[$key]['value']=$value;
                        }
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Allotted
                        <small>Overview of orders allotted</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Allotted</li>
                    </ol>
                </section>

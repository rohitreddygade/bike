...
<body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <script src="../../script/js/plugins/js/highcharts.js"></script>
                        ...
                        <h4>Comparison of Orders and Allocation - Company wise</h4>
                        ...
                        <div class="form-group" style="float:left;margin-left:20px;">
                                         <label>Select Company<span class="error" id="scat">*</span></label>
                    ...
                    <div class="box-body table-responsive">
                                    <table id="pickUpTab" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th class="sorting_desc">Showroom</th>
                                                <th>Rating</th>
                                                <th>Total Orders</th>
                                                <th>Serviced</th>
                                                <th>New Order</th>
                        ...
                        <h4>Comparison of Orders and Allocation - Location wise</h4>
                        <p>The following bar graph helps you to compare order statistics and allocation for different showrooms in the location/area selected.</p>
                        </div>
                        <div class="form-group" style="float:left;margin-left:20px;">
                                         <label>Select Location<span class="error" id="scat">*</span></label>
                                        <select class="form-control" id="mark" name="mark">
                                         <option value="">--Select--</option>
        ...
        $('#container11').highcharts({
            ...
            title: {
                text: 'Vendor Statistic Report for Showrooms of Hero'
            },
            subtitle: {
                text: 'Source: MotoRevive'
            },
            xAxis: {
                categories: ['Rishi Hero', 'Haiku Hero', 'Sai Hero', 'Joy Hero', 'Lakshmi Motors' ,'Dev Motors'],
                title: {
                    text: null
                }
            },
    ...
    $('#container12').highcharts({
            ...
            title: {
                text: 'Vendor Statistic Report for Showrooms near Whitefield'
            },
            subtitle: {
                text: 'Source: MotoRevive'
            },
